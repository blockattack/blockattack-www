...
[Linux no-installer 2.3.0](https://github.com/blockattack/blockattack-game/releases/download/v2.3.0/blockattack-linux-2.3.0.tar.bz2){:class="download-link"}

[Windows installer 2.3.0](https://github.com/blockattack/blockattack-game/releases/download/v2.3.0/blockattack-installer-2.3.0.exe){:class="download-link"}

[Windows no-installer 2.3.0](https://github.com/blockattack/blockattack-game/releases/download/v2.3.0/blockattack-2.3.0-windows-no-installer.zip){:class="download-link"}

[Source 2.3.0](https://github.com/blockattack/blockattack-game/archive/v2.3.0.tar.gz){:class="download-link"}
