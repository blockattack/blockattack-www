...
In addition to traditional game types like endless, time trial and stage clear the game does also feature a VS-mode. The VS mode is a duel like you rarely see in a puzzle game.

The game is programmed by me (Poul Sander) and is released under the GPL license version 2.
All the artwork is free too.
...
# System requirements:
  ...
  * Screen resolution: native is 768p but it can scale to other resolutions. You don't want to go for a too low resolution
  * Keyboard
  * OS:
    * Linux: Oldest supported Ubuntu LTS version or later
    * Windows: Windows 7, 8 or 10 (32 or 64 bit)

The game is using the [SDL2 library](http://www.libsdl.org/), [SDL_Mixer](http://www.libsdl.org/projects/SDL_mixer), [SDL_image](http://www.libsdl.org/projects/SDL_image/), [SDL_ttf](https://www.libsdl.org/projects/SDL_ttf/), [PhysicsFS](https://icculus.org/physfs/), boost, [cpputf](http://utfcpp.sourceforge.net/), [cereal](https://uscilab.github.io/cereal/) and [RapidJSON](http://rapidjson.org)
